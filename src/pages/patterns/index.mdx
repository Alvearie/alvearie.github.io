...
To get started today, use the [clinical data enrichment pattern today](https://github.com/Alvearie/health-patterns/tree/main/enrich) but watch this space - the _Enrichment_ pattern will be available separately soon.
