...
has to offer. Start with the main Alvearie page ([https://alvearie.github.io](https://alvearie.github.io)) and read through the 
...
No matter who you are, contributing to the project at any level starts here. Request access and join our Slack channels, follow 
discussions and issue boards, and in general become part of the community. These are things **you can do right now**!
...
if you see a mistake or a need to add an additional step, create an issue. Or, better yet, create a fix and propose contributing 
...
fixed. For Alvearie, these bugs are tracked as issues in the repositories. One of the best ways to get involved, if you are so 
